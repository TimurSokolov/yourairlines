...
public class PlaneController extends CrudController<Plane, PlaneDto> {
  ...
  @Autowired private PlaneMapper planeMapper;
  ...
  public List<Plane> searchSuitablePlanes(
      @RequestParam Long departureAirportId, Long arrivalAirportId, LocalDateTime departureTime) {
